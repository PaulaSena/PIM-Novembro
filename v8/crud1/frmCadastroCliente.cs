...
using crud1.BDCADASTRODataSetTableAdapters;
using System;
...
namespace crud1
{
    public partial class frmCadastroCliente : Form
    {
      ...
      //  CLIENTETableAdapter clienteTable = new CLIENTETableAdapter();

        //private static CLIENTETableAdapter CLIENTETableAdapter()
        //{
        //    throw new NotImplementedException();
        //}

        public object BdCadastroDataSet;


        private void frmCadastroCliente_Load(object sender, EventArgs e)
        {
          //  dgvClientes.DataSource = cLIENTETableAdapter.GetData();            
            
            // TODO: esta linha de código carrega dados na tabela 'bDCADASTRODataSet.CLIENTE'. Você pode movê-la ou removê-la conforme necessário.
          //  this.cLIENTETableAdapter.Fill(this.bDCADASTRODataSet.CLIENTE);
        ...
        {
            //string sql = "SELECT * FROM CLIENTE WHERE ID Nome=" + tstId.Text + txtNome.Text;
            string sql = "SELECT *  FROM CLIENTE WHERE ID = "  + tstId.Text;
            //   "SELECT ID, NOME, ENDERECO, CEP, BAIRRO, CIDADE, UF, TELEFONE FROM CLIENTE WHERE(NOME LIKE @NOME + '%')="
            SqlConnection con = new SqlConnection(connectionString);
            SqlCommand cmd = new SqlCommand(sql, con);
            cmd.CommandType = CommandType.Text;
        ...
        // Data Source = DESKTOP - 9J2BVIQ;Initial Catalog = BDCADASTRO; Integrated Security = True
        {
            if (txtBuscaId.Text != "")
            {
            ...
            else
            {
                ...
                if (txtBuscaId.Text == "" && txtBuscaNome.Text == "") {
                    MessageBox.Show("Nenhum registro encontrado com o dado informado!");
                }
