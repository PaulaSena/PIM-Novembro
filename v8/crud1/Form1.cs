...
namespace crud1
{
    public partial class Form1 : Form
    {
        ...
        private void BtnNomeInserir_Click(object sender, EventArgs e)
        {
            ...
            con.Open();
            SqlCommand command = new SqlCommand("insert into Pessoa values ('" + int.Parse(txtIdPessoa.Text) + "','" + txtNome.Text + "','" + txtSobrenome.Text + "','" + cbxEmailPromo.Text + "', getdate()'" + DateTime.Parse(dataTimeS.Text) + "')");
